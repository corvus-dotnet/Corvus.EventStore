...
namespace Corvus2.EventStore.Core
{
    ...
    public interface IEventReader
    {
        ...
        /// </summary>
        /// <param name="utf8TextContinuationToken">A continuation token returned from a previous call that can be used to
        /// obtain the next set of results.</param>
        /// <returns>The results, contained in an <see cref="EventReaderResult"/>.</returns>
        ValueTask<EventReaderResult> ReadAsync(ReadOnlySpan<byte> utf8TextContinuationToken);
    }
}
