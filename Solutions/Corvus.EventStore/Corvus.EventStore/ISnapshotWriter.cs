...
namespace Corvus.EventStore
{
    ...
    public interface ISnapshotWriter
    {
        ...
        /// <param name="storeMetadata">Metadata for the store related to this snapshot.</param>
        ...
        Task Write<TMemento>(Guid aggregateId, long commitSequenceNumber, long eventSequenceNumber, ReadOnlyMemory<byte> storeMetadata, in TMemento memento);
    }
}
