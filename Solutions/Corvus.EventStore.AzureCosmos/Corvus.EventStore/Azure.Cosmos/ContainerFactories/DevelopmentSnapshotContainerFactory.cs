// <copyright file="DevelopmentSnapshotContainerFactory.cs" company="Endjin Limited">
...
namespace Corvus.EventStore.Azure.Cosmos.ContainerFactories
{
    ...
    public readonly struct DevelopmentSnapshotContainerFactory : ISnapshotContainerFactory
    {
        ...
        public DevelopmentSnapshotContainerFactory(string databaseName, string containerName)
        {
